<div class="container mt-3">
  ...
  <div class="row">
    ...
    <div class="col">
      <button type="button" class="btn btn-primary mt-3 mb-3 tombolTambahData" data-bs-toggle="modal" data-bs-target="#formModal">Tambah Data Mahasiswa</button>
        ...
        <ul class="list-group">
          <?php foreach ($data['mhs'] as $mhs) : ?>
            <li class="list-group-item ">
              ...
              <!-- id ditangkap oleh jquery -->
              <a href="<?= BASEURL; ?>/mahasiswa/edit/<?= $mhs['id']; ?>" class="badge text-bg-warning text-white float-end me-3 p-2" style="text-decoration: none" data-bs-toggle="modal" data-bs-target="#formModal" class="tampilModalEdit" data-id=<?= $mhs['id']; ?>>Edit</a>
            </li>
          <?php endforeach; ?>
        </ul>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= BASEURL; ?>/mahasiswa/tambah" method="post">
        <div class="mb-3">
          <input type="hidden" class="form-control" id="id" aria-describedby="id" name="id" >
        </div>
        <div class="mb-3">
